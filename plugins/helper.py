...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player V3.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @abhinasroy 😉!"
HELP_TEXT = """
🎧 --**Need Help ?**--
(Join @DOSTI_GROUP_1234 For Support)
    ...
    if query.data == "replay":
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton("SUPPORT", url="https://t.me/DOSTI_GROUP"),
            ],
            [
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/d404ce5e006643c809eaa.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
